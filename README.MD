...
Add the logic to `addToCart()` method such that it should _return an updated cart list_ after adding a valid menu item to cart. If the item is already present, then update quantity and total of that item.
